...
namespace xal
{
	...
	bool XAudio2_Player::_systemIsPlaying() const
	{
		return this->playing;
	}

	unsigned int XAudio2_Player::_systemGetBufferPosition() const
	{
		this->sourceVoice->GetState((XAUDIO2_VOICE_STATE*)&this->xa2State[0], 0);
	...
	void XAudio2_Player::_submitBuffer(hstream& stream)
	{
		...
		this->xa2Buffer.pAudioData = (unsigned char*)stream;
